import { products } from '../data/products.js';
    document.addEventListener("DOMContentLoaded", function () {
        ...
        cart.forEach((item, index) => {
            ...
            li.querySelector('.header__cart-item-decrease').addEventListener('click', () => {
                if (item.quantity > 1) {
                    ...
                    cart.splice(index, 1); // Remove item if quantity is 0 - do not leave in basket at null value
                }
        ...
        cartTotalElement.textContent = total.toFixed(2); //to fixed = Decimal places
    }
